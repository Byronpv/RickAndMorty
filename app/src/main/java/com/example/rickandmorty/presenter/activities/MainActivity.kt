...
import com.example.rickandmorty.presenter.viewmodel.MainViewModelFactory
import com.example.rickandmorty.presenter.adapter.CharacterAdapter
import com.example.rickandmorty.presenter.viewmodel.MainViewModel

class MainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding
    private val viewModel: MainViewModel by viewModels(
        factoryProducer = { MainViewModelFactory(RetrofitClient.characterApiService) }
    )
